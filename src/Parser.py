def get_args():
    ...
    import argparse
    import os
    default_dire = '/home/mongardi/Metagene_repo/data/prior_knowledge'
    #default_dire = '/home/mongardi/Metagene_repo/test'
    ...
    parser.add_argument('--genes_ids_file_dir', type=str, default= os.path.join(default_dire, 'genes_and_ids_all_red.csv'))
    ...
    parser.add_argument('--save_files_dir', type=str, default= '/home/mongardi/Metagene_repo/data/prior_knowledge_updated')
    ...
    # datasets 
    parser.add_argument('--BRCA_dataset_dir', type=str, default= '/home/mongardi/Metagene_repo/data/data_BRCA/BRCA_dataset.csv')
    parser.add_argument('--BRCA_dataset_index_col', type=str, default='sample_id')
    parser.add_argument('--BRCA_results_dir', type=str, default= '/home/mongardi/Metagene_repo/results/BRCA')
    parser.add_argument('--CRC_dataset_dir', type=str, default= '/home/mongardi/Metagene_repo/data/data_CRC/CRC_dataset.csv')
    parser.add_argument('--CRC_dataset_index_col', type=str, default='Unnamed: 0')
    parser.add_argument('--CRC_results_dir', type=str, default= '/home/mongardi/Metagene_repo/results/CRC')
